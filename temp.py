...
# Get the arguments
args = get_arguments()
output_depth_dirT = '/home/shambel/SparConv/featuremaps/softmaxT'
output_depth_dir1T = '/home/shambel/SparConv/featuremaps/beforesoftmaxT'
output_depth_dir2T = '/home/shambel/SparConv/featuremaps/argmaxT'
output_depth_dirIDWT = '/home/shambel/SparConv/featuremaps/idwT'

output_depth_dirV = '/home/shambel/SparConv/featuremaps/softmaxV'
output_depth_dir1V = '/home/shambel/SparConv/featuremaps/beforesoftmaxV'
output_depth_dir2V = '/home/shambel/SparConv/featuremaps/argmaxV'
output_depth_dirIDWV = '/home/shambel/SparConv/featuremaps/idwV'
...
class SparseConvNet(nn.Module):
    ...
    def forward(self, x, mask):
        ...
        '''
        #arg_max = torch.argmax(soft_max.detach(), dim = 1, keepdim=True).cpu().numpy()
        if step ==1:
            ...
            for ax in grid:
                ax.set_axis_off()
                im = ax.imshow((softmax[0][i].cpu().detach()), vmin=0, vmax=1, cmap= 'turbo') 
                i +=1  
            file_path = output_depth_dirV + '/' + str(step) + '.png'
